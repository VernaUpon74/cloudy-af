...
function chartOptions(theme) {
    ...
    return {
        ...
        // Single shared axis, min pinned at 0, max auto-scaled from the
        // VISIBLE series (same as the original canvas chart): hiding the
        // 500 °F setpoint via its checkbox rescales watts/volts/ohms back
        // into readable range.
        yAxis: {
            min: 0,
            ...axis,
